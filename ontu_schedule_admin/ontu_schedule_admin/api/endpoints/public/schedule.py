...
from main.operations.schedule import get_day_schedule_by_group, get_week_schedule_by_group
...
def get_schedule(
    ...
    return get_week_schedule_by_group(
        group=group,
...
def get_day_schedule(
    ...
    return get_day_schedule_by_group(
        group=group,
        for_day=for_day,
        ignore_cache=ignore_cache,
    )
